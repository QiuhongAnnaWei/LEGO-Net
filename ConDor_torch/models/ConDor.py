import torch
from ConDor_torch.models.TFN import TFN
from ConDor_torch.models.layers import MLP, MLP_layer
from ConDor_torch.utils.group_points import GroupPoints
from ConDor_torch.spherical_harmonics.spherical_cnn import torch_fibonnacci_sphere_sampling, SphericalHarmonicsEval, SphericalHarmonicsCoeffs, zernike_monoms
from ConDor_torch.spherical_harmonics.kernels import SphericalHarmonicsGaussianKernels, ShGaussianKernelConv
from ConDor_torch.models.layers import MLP, MLP_layer, set_sphere_weights, apply_layers, type_1
from ConDor_torch.utils.pooling import kd_pooling_1d
...
class ConDor(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        points_code_out = points_inv
        points_inv = self.points_inv_layer(points_inv)


        out = {"T": T, "caps": capsules, "points_inv": points_inv, "E": E, "points_code": points_code_out}
